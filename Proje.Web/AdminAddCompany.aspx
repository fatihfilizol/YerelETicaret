<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminAddCompany.aspx.cs" Inherits="Proje.Web.AdminAddCompany" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: center">
        ...
        <div style="text-align:center">
            <asp:Button ID="Button1" runat="server" Text="Firma Ekle" CssClass="btn btn-info" OnClick="Button1_Click" />
        </div>
        </form>
</asp:Content>
